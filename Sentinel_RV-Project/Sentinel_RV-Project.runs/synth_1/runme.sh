...
HD_PWD='C:/VIVADO-proj1/New folder/Sentinel_RV-Project/Sentinel_RV-Project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sentinel_rv_board_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sentinel_rv_board_top.tcl

...
​```
+-----------------------+      +----------------------------------+      +------------------------+
| 4x Slide Switches     | ---> |  Top Board Wrapper               | ---> | 8x Status LEDs         |
| (S1, S2, S4, S5)      |      |  (sentinel_rv_board_top.v)       |      | (L1 - L8)              |
+-----------------------+      +-----------------+----------------+      +------------------------+
                                                 |
                                                 v
+------------------------------------------------+------------------------------------------------+
...
|                                                                                                 |
|  +--------------------+   +---------------------+   +--------------------+   +---------------+  |
|  | DHT11 Temp/Humidity|   | MCP3202 12-bit ADC  |   | XADC Internal      |   | Piezo Siren   |  |
|  | Sensor Reader      |   | SPI Sampler         |   | Voltage/Temp       |   | Buzzer Ctrl   |  |
|  +--------------------+   +---------------------+   +--------------------+   +---------------+  |
|                                                                                                 |
|  +--------------------+   +----------------------------------------------------+               |
|  | Form-C Safety      |   | Full-Duplex UART Serial Controller (115200 baud)   |               |
|  | Relay Actuator     |   +----------------------------------------------------+               |
|  +--------------------+                                                                         |
|                                                                                                 |
|  +----------------------------------------------+   +----------------------------------------+  |
|  | Audit Log Writer (audit_log_writer.v)        |   | SPI Micro-SD Sector Writer             |  |
|  +----------------------------------------------+   +----------------------------------------+  |
+-------------------------------------------------------------------------------------------------+
​```

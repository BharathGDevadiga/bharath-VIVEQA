...
HD_PWD='C:/VIVADO-proj1/New folder/Sentinel_RV-Project/Sentinel_RV-Project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sentinel_rv_board_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sentinel_rv_board_top.tcl -notrace

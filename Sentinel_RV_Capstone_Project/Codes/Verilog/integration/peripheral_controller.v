...
// Arbitration only: this module transports untrusted commands to Security Core and
// broadcasts Security Core telemetry to both outbound links. It performs no access

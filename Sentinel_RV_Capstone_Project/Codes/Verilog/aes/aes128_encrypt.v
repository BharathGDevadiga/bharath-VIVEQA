...
module aes128_encrypt (
    ...
    reg [3:0] round;
    wire [127:0] next_key;
    // next_key is combinational so it is always current-cycle correct
    ...
    // Combinational: always reflects next round key from current round_key and round counter
    assign next_key = next_round_key(round_key, rcon(round));

...
module sevenseg_driver #(
    ...
    function [15:0] transfer_word;
        ...
        begin
            case (index)
                4'd0: transfer_word = 16'h0F00; // display test off
                4'd1: transfer_word = {8'h0C, display_enable ? 8'h01 : 8'h00};
                4'd2: transfer_word = 16'h0B03; // scan four digits
                4'd3: transfer_word = 16'h0907; // BCD decode for digits 1..3, raw segments for digit 4
                4'd4: transfer_word = 16'h0A03; // Set Medium Intensity (saves 65% power)
                4'd5: transfer_word = {8'h01, 4'h0, number[3:0]};
                4'd6: transfer_word = {8'h02, 4'h0, number[7:4]};
                4'd7: transfer_word = {8'h03, 4'h0, number[11:8]};
                default: transfer_word = {8'h04, number[15:8]}; // Raw segment byte for Digit 4
            endcase
        end
    endfunction

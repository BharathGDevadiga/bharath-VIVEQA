...
`tb_logic_gates.v` contains the testbench used to simulate and verify the functionality of all the implemented logic gates by applying different input combinations and observing the outputs.
